...
2. **Positive Form:** Describe what is, not what isn't.
3. **Parallelism:** Express coordinate ideas in similar form.

### Step 3: The Hemingway Audit (Source: Hemingway App methodology)
Identify and fix readability "Red Flags":
1. **Yellow/Red Sentences:** Split sentences that are too long or contain more than two clauses.
2. **Purple Words:** Replace complex vocabulary with everyday English.
3. **Blue Adverbs:** Delete them or upgrade the verb.
...
1. **The Down Draft:** Getting it all down (Child's draft).
2. **The Up Draft:** Fixing it up (Grown-up draft).
3. **The Dental Draft:** Checking every tooth (Editor's draft).
...
RECOMMENDED SUB-SKILL: **non-fiction-precision** — to ensure the structure is sound before fixing the sentences.
