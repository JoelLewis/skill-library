...
REQUIRED SUB-SKILL: **non-fiction-precision** — to ensure the prose is clear enough to be tested.
RECOMMENDED SUB-SKILL: **assumption-audit** — to validate the data behind the logic.
